...
|Old Data| New Data  |
|--|--|
| Equal proportion of all tasks retained to use for next round. About 11,990 old tasks saved for use in next round throughout process. | About 11, |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTIyNjg4OTI2LC0xNjg3NTc2MzM4LDEyNz
